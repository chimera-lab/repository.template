...
- [:file\_folder: CMR CLI Knowledge](./#file_folder-cmr-cli-knowledge)
  ...
  - [:building\_construction: Structure](./#building_construction-structure)
    ...
    - [:building\_construction: Commands & Subcommands](./#building_construction-commands-subcommands)
      ...
      - [:building\_construction: cmr docs](./#building_construction-cmr-docs)
        ...
        - [:building\_construction: cmr docs templates](./#building_construction-cmr-docs-templates)
  ...
  - [:world\_map: Guide: Quick Tasks](./#world_map-guide-quick-tasks)
    - [:world\_map: Discover repositories](./#world_map-discover-repositories)
    - [:world\_map: Check documentation](./#world_map-check-documentation)
    - [:world\_map: GitHub resources](./#world_map-github-resources)
